<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"F:\www\2018\practice_blog\think\public/../application/admin\view\link\add.html";i:1525250415;s:83:"F:\www\2018\practice_blog\think\public/../application/admin\view\common\header.html";i:1524052063;s:81:"F:\www\2018\practice_blog\think\public/../application/admin\view\common\left.html";i:1525249736;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>BikeCms</title>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('link/add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="desc" class="col-sm-2 control-label no-padding-right">链接简介</label>
                            <div class="col-sm-6">
